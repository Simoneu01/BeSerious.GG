...
<div class="grid grid-cols-1 gap-6 bg-gray-200 bg-opacity-25 p-6 dark:bg-gray-800 md:grid-cols-2 lg:gap-8 lg:p-8">
    <div>
        <div class="flex items-center">
            <svg class="h-6 w-6 stroke-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                stroke-width="1.5">
        ...
        <p class="mt-4 text-sm">
            <a class="inline-flex items-center font-semibold text-indigo-700 dark:text-indigo-300"
                ...
                <svg class="ml-1 h-5 w-5 fill-indigo-500 dark:fill-indigo-200" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20">
