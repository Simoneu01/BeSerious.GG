                                    ...
                                    <thead>
                                        <tr>
                                            <th class="w-8 px-6 py-3 pr-0 text-left">
                                                <div
                                                    class="text-cool-gray-500 text-xs font-medium uppercase leading-4 tracking-wider">
                                                    #</div>
                                            </th>
                                            ...
                                            <tr class="">
                                                <td
                                                    ...
                                                    <svg class="mr-1 h-4 w-4"
                                                        style="color: {{ $this->getTrophyColor($loop->index + 1) }}"
                                                ...
                                                <td
                                                    class="whitespace-no-wrap text-cool-gray-900 px-6 py-4 text-sm leading-5">
                                                    <p class="text-cool-gray-600 truncate hover:font-bold">
                                                        <a
                                                            href="https://gameshard.io/teams/{{ $team['contestant']['id'] }}">
