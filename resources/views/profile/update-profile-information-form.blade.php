<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input class="mt-1 block w-full" id="name" type="text" wire:model.defer="state.name" required
                autocomplete="name" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input class="mt-1 block w-full" id="email" type="email" wire:model.defer="state.email" required
