    ...
    var t,
        e = {
                ...
                t.exports = function (t) {
                    return new Promise(function (e, n) {
                        ...
                        if (
                            ...
                            var E =
                                (t.withCredentials || s(x)) && t.xsrfCookieName
            ...
            429: (t, e, n) => {
                ...
                function E() {
                    (A = A.concat(b.takeRecords())).length &&
                        !O &&
                        ((O = !0),
                        queueMicrotask(() => {
                            C(A), (A.length = 0), (O = !1);
                ...
                function kt(t, e = yt) {
                    !(function (t) {
                        ...
                        (nt = e), et.set(e, []);
                        let n = () => {
                            for (; et.get(e).length; ) et.get(e).shift()();
                            et.delete(e);
                        };
                        t(n), (tt = !1), n();
                    })(() => {
                ...
                var Jt = {
                    ...
                    start: function () {
                        ...
                        document.body ||
                            ...
                            ht(document, "alpine:init"),
                            ht(document, "alpine:initializing"),
                            w(),
                            (t = (t) => kt(t, yt)),
                            g.push(t),
                            y((t) => {
                ...
                function ln(t, e, n, r, i) {
                    if (!ie(t))
                        return (
                            console.warn(
                                `value cannot be made reactive: ${String(t)}`
                            ),
                            t
                        );
                ...
                function vn(t, e, n) {
                    B(e, (e) =>
                        mt(
                            `You can't use [$${directiveName}] without first installing the "${t}" plugin here: https://alpine.dev/plugins/${n}`,
                            e
                        )
                    );
                }
                B("id", (t) => (e, n = null) => {
                    ...
                    Y("teleport", (t, { expression: e }, { cleanup: n }) => {
                        ...
                        (t._x_teleport = i),
                            ...
                            T(i, {}, t),
                            j(() => {
                                r.appendChild(i), kt(i), (i._x_ignore = !0);
                            }),
                            n(() => i.remove());
                    });
                var gn = () => {};
                ...
                function An(t, e, n) {
                    Y(e, (r) =>
                        mt(
                            `You can't use [x-${e}] without first installing the "${t}" plugin here: https://alpine.dev/plugins/${n}`,
                            r
                        )
                    );
                }
                (gn.inline = (t, { modifiers: e }, { cleanup: n }) => {
                    ...
                    Y("ignore", gn),
                    Y("effect", (t, { expression: e }, { effect: n }) =>
                        n(F(t, e))
                    ),
                    Y(
                        "model",
                    ...
                    Y("id", (t, { expression: e }, { evaluate: n }) => {
                        n(e).forEach((e) =>
                            (function (t, e) {
                                t._x_ids || (t._x_ids = {}),
                ...
                (t = n.nmd(t)),
                    function () {
                        ...
                        var gn = (function t(e) {
                            ...
                            function xi(t, e) {
                                return Ku(t) ? t : Eo(t, e) ? [t] : Bo(xa(t));
                            }
                            var wi = Yr;
                            function Ei(t, e, n) {
                                var r = t.length;
                            ...
                            function Ui(t) {
                                return function (e) {
                                    return Ie(tc(Ha(e).replace(Yt, "")), t, "");
                                };
                            }
                            function Bi(t) {
                                return function () {
                            ...
                            function aa(t) {
                                ...
                                if (null === e) return !0;
                                var n =
                                    Pt.call(e, "constructor") && e.constructor;
                                return (
                                    "function" == typeof n &&
                                    n instanceof n &&
                                    It.call(n) == Mt
